...
function updateNetworkStatus(peerCount) {
    ...
    if (!statusEl) {
        ...
        // Find the placeholder div with id="network-status" from index.html
        const placeholder = document.getElementById('network-status');
        if (placeholder) placeholder.appendChild(statusEl);
    }
